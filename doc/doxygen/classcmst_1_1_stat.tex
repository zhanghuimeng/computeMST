...
Set m\_max to DOUBLE\_MIN and m\_min to DOUBLE\_MAX 
...
\index{cmst::Stat@{cmst::Stat}!standardDeviation@{standardDeviation}}
\index{standardDeviation@{standardDeviation}!cmst::Stat@{cmst::Stat}}
\subsubsection[{\texorpdfstring{standardDeviation()}{standardDeviation()}}]{\setlength{\rightskip}{0pt plus 5cm}double cmst::Stat::standardDeviation (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\index{cmst::Stat@{cmst::Stat}!m\_data@{m\_data}}
\index{m\_data@{m\_data}!cmst::Stat@{cmst::Stat}}
...
\index{cmst::Stat@{cmst::Stat}!m\_max@{m\_max}}
\index{m\_max@{m\_max}!cmst::Stat@{cmst::Stat}}
...
\index{cmst::Stat@{cmst::Stat}!m\_mean@{m\_mean}}
\index{m\_mean@{m\_mean}!cmst::Stat@{cmst::Stat}}
...
\index{cmst::Stat@{cmst::Stat}!m\_min@{m\_min}}
\index{m\_min@{m\_min}!cmst::Stat@{cmst::Stat}}
...
\index{cmst::Stat@{cmst::Stat}!m\_standardDeviation@{m\_standardDeviation}}
\index{m\_standardDeviation@{m\_standardDeviation}!cmst::Stat@{cmst::Stat}}
